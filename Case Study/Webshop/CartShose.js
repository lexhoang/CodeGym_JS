...
function renderCart() {
    ...
    for (let i = 0; i < cartProduct.length; i++) {
        ...
        data += "</tr>"
        data += "<tr>"
        data += "<td><input type='radio' name='size' '/>35"
        data += "<td><input type='radio' name='size' />36"
        data += "<td><input type='radio' name='size' />38"
        data += "<td><input type='radio' name='size' />39"
        data += "<td><input type='radio' name='size' />40"
        data += "</tr>"
    }
    data += "<table>"
